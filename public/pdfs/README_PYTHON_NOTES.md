# Python Handwritten Notes - Manual Upload Required
...
2. Download the Python handwritten notes PDF
3. Save the file as `python-handwritten-notes.pdf` in the `/public/pdfs/` directory
4. Replace the empty placeholder file that currently exists

## Credits
These notes were created by **Dheerendra Singh** and shared on LinkedIn. The credits are already included in the Python course page with a link to his LinkedIn profile.

## Integration
The PDF link and credits have been added to the Python course page at `/app/courses/python-basics/page.tsx`.
