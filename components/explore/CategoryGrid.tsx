...
const categories = [
    {
        title: "Development",
        description: "Python, Web, Mobile App...",
        courses: 120,
        icon: Monitor,
        color: "bg-blue-600",
        tag: "Popular for Beginners",
    ...
    },
    {
        ...
        icon: PenTool,
        color: "bg-pink-600",
        tag: "New Content Added",
        tagColor: "text-pink-400"
    },
    {
        title: "Business",
        description: "Finance, Entrepreneurship...",
        courses: 50,
        icon: TrendingUp,
        color: "bg-amber-600",
        tag: "Top Rated Mentors",
    ...
    },
    {
        ...
        icon: Megaphone,
        color: "bg-purple-600",
        tag: "Career Paths Available",
        tagColor: "text-purple-400"
    },
    {
        title: "Photography",
        description: "Digital, Editing, Video...",
        courses: 36,
        icon: Camera,
        color: "bg-red-600",
        tag: "Workshop Series",
    ...
    {
        title: "Music",
        description: "Theory, Instruments, Prod...",
        courses: 28,
        icon: Music,
        color: "bg-cyan-600",
        tag: "New Masterclass",
    ...
    {
        title: "Self Growth",
        description: "Leadership, Productivity...",
        courses: 93,
        icon: Star,
        color: "bg-orange-600",
        tag: "Best Sellers",
