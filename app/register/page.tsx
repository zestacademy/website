...
export default function RegisterPage() {
    ...
    useEffect(() => {
        ...
        if (errorParam) {
            const errorMessages: Record<string, string> = {
                ...
                'state_mismatch': 'Security check failed. Please try signing up again.',
                'missing_verifier': 'Authentication verification failed. Please try again.',
                'token_exchange_failed': 'Failed to complete authentication. Please try again.',
                'server_error': 'Server error occurred. Please try again later.',
            }
            setError(errorMessages[errorParam] || 'An error occurred during signup. Please try again.')
    ...
    async function handleSignup() {
        ...
        try {
            ...
            console.error(e)
            setError(e.message || "Failed to initiate signup. Please try again.")
            setShowErrorDialog(true)
        } finally {
            setIsLoading(false)
        }
