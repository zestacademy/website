...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        const unsubscribe = auth.onAuthStateChanged((user) => {
            // If we are processing a Google Login, we will handle the redirect/dialog manually in that function.
            // Do not redirect here in that case.
            if (user && !showWelcomeDialog && !isProcessingGoogleLogin) {
                router.push("/")
            }
        })
        return () => unsubscribe()
    }, [router, showWelcomeDialog, isProcessingGoogleLogin])
    ...
    async function onSubmit(event: React.SyntheticEvent) {
        ...
        try {
            ...
            // Redirect handled by onAuthStateChanged as well, but this is faster for manual login
            router.push("/")
        } catch (e: any) {
            console.error(e)
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    ...
                    <div className="flex flex-col space-y-2 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Sign in with your Zest ID or Google account to continue
                        </p>
                    </div>
                    <Card className="border-none shadow-none">
                        <CardContent className="p-0">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Button variant="outline" disabled={isLoading} onClick={() => console.log("Zest ID login")}>
