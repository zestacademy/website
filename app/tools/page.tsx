...
import { PenTool, ArrowRight, Wrench, Sparkles } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {toolsList.map((tool) => {
            ...
            return (
              <Card key={tool.title} className="flex flex-col justify-between hover:shadow-lg transition-all duration-300 border-muted">
                <CardHeader>
